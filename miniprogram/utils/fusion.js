...
async function fetchModelWeather(lat, lon, modelId) {
  const params = [
    `latitude=${lat}`,
    `longitude=${lon}`,
    'hourly=temperature_2m,relative_humidity_2m,dew_point_2m,pressure_msl,cloud_cover,cloud_cover_low,precipitation,visibility,precipitation_probability,wind_speed_10m',
